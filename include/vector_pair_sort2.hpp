 ...
 * This version of @ref vector_pair_sort uses iterators when copying values and indexes from sorted vector. This implementation exists
 * just to compare the speed of the two approaches.
 *
...
void vector_pair_sort2(RandomIt1 value_begin, RandomIt1 value_end, RandomIt2 index_begin, RandomIt2 index_end, Compare cmp)
{
    ...
    for (auto vector_iter(conversion.begin()); vector_iter != conversion.end(); ++vector_iter, ++value_begin, ++index_begin)
    {
