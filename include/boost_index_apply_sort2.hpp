 ...
 *
 * This algorithm behaves like @ref boost_index_apply_sort but it sorts a local
 * copy of index, copies it to `index_begin` and then it applies it.
 *
...
void boost_index_apply_sort2(RandomIt1 value_begin,
                             RandomIt1 value_end,
